module.exports=[2925,67193,41152,73831,e=>{"use strict";e.i(43178);var t=e.i(97700),a=e.i(11259),i=e.i(66680);async function r(){await t.prisma.$executeRaw`
  ...
  `)).map(e=>({id:e.id,status:e.status,companyName:e.companyName??"Empresa",candidateName:e.candidateName??"Candidato",applicationId:e.applicationId,messagesCount:e.messagesCount??0,reportsCount:e.reportsCount??0,warningsCount:e.warningsCount??0,lastMessageAt:d(e.lastMessageAt),updatedAt:d(e.updatedAt)??new Date().toISOString()}))}async function p(){return(await a.prisma.$queryRaw(t.Prisma.sql`
    ...
    LIMIT 20
  `)).map(e=>({id:e.id,status:e.status,requestedStage:e.requestedStage,applicationId:e.applicationId,companyName:e.companyName??"Empresa",candidateName:e.candidateName??"Candidato",sentAt:d(e.sentAt)??new Date().toISOString(),respondedAt:d(e.respondedAt),rejectCooldownUntil:d(e.rejectCooldownUntil)}))}async function m(){return(await a.prisma.session.findMany({include:{user:{select:{id:!0,role:!0,displayName:!0}}},orderBy:{createdAt:"desc"},take:20})).map(e=>({userId:e.userId,displayName:e.user?.displayName??e.userId,role:e.user?.role??"candidate",createdAt:e.createdAt.toISOString(),expiresAt:e.expiresAt.toISOString(),revokedAt:d(e.revokedAt)}))}async function f(){return(await a.prisma.verificationRequest.findMany({orderBy:{submittedAt:"desc"},take:20})).map(e=>({id:e.id,role:e.role,status:e.status,userId:e.userId,notes:e.notes??void 0,submittedAt:e.submittedAt.toISOString(),reviewedAt:d(e.reviewedAt)}))}async function y(e){return(await a.prisma.event.findMany({where:{...e?.type?{type:e.type}:{},happenedAt:{...e?.from?{gte:e.from}:{},...e?.to?{lte:e.to}:{}}},orderBy:{happenedAt:"desc"},take:e?.limit??50,select:{id:!0,type:!0,actorRole:!0,entityId:!0,pathname:!0,source:!0,happenedAt:!0,metadataJson:!0}})).map(e=>{let t;return{...(t=function(e){if(!e)return null;try{let t=JSON.parse(e);return t&&"object"==typeof t?t:null}catch{return null}}(e.metadataJson),{targetPath:"string"==typeof t?.requestUrl?t.requestUrl:e.entityId,method:"string"==typeof t?.method?t.method:null,statusCode:"number"==typeof t?.statusCode?t.statusCode:null,durationMs:"number"==typeof t?.durationMs?t.durationMs:null}),id:e.id,type:e.type,actorRole:e.actorRole,entityId:e.entityId,pathname:e.pathname,source:e.source,happenedAt:e.happenedAt.toISOString()}})}async function h(e){var t;let[a,o,d,h,v,g,A,w,_,E]=await Promise.all([(0,s.getAdminOverview)(),(0,s.listUsersForAdmin)(),(0,s.listJobsForAdmin)(),m(),f(),n(),u(),p(),y({type:e?.activityType,from:e?.activityFrom,to:e?.activityTo,limit:e?.activityLimit}),i()]),S=o.filter(e=>"candidate"===e.role&&"private"===e.profileVisibility).length,N=o.filter(e=>"company"===e.role&&"verified"!==e.verificationStatus).length,T=d.filter(e=>"draft"===e.status).length,R=d.filter(e=>"paused"===e.status).length,I=v.filter(e=>"pending"===e.status).length,C=g.filter(e=>"retention"===e.source).length,O=A.filter(e=>e.reportsCount>0||"pending_review"===e.status).length,b=w.filter(e=>"pending"===e.status).length,M=h.filter(e=>!e.revokedAt&&new Date(e.expiresAt).getTime()>Date.now()).length,U=A.filter(e=>"active"===e.status).length,L=A.filter(e=>"pending_review"===e.status).length,P={ok:!0,metrics:{...a.metrics,activeSessionsTotal:M,pendingInvitesTotal:b,activeChatsTotal:U,pendingReviewChatsTotal:L,verificationPendingTotal:I,failedRetentionTotal:C,reportedChatsTotal:O},tasks:[{id:"ADM-1001",title:"Revisar candidatos privados",description:"Hay candidatos registrados que no están visibles para empresas.",category:"users",status:l((t={privateCandidates:S,unverifiedCompanies:N,draftJobs:T,pausedJobs:R,pendingVerifications:I,failedRetention:C,reportedChats:O,pendingInvites:b}).privateCandidates),priority:c(t.privateCandidates),href:"/admin/usuarios",tags:["candidate","visibility"],metric:`${t.privateCandidates}`},{id:"ADM-1002",title:"Gestionar empresas no verificadas",description:"Empresas creadas aún sin verificación aprobada.",category:"auth",status:l(t.unverifiedCompanies),priority:c(t.unverifiedCompanies),href:"/admin/auth",tags:["company","verification"],metric:`${t.unverifiedCompanies}`},{id:"ADM-1003",title:"Vacantes en borrador por revisar",description:"Publicaciones creadas pero no publicadas.",category:"jobs",status:l(t.draftJobs),priority:c(t.draftJobs),href:"/admin/vacantes",tags:["jobs","draft"],metric:`${t.draftJobs}`},{id:"ADM-1004",title:"Vacantes pausadas",description:"Publicaciones ocultas que pueden requerir acción.",category:"jobs",status:l(t.pausedJobs),priority:c(t.pausedJobs,2),href:"/admin/vacantes",tags:["jobs","paused"],metric:`${t.pausedJobs}`},{id:"ADM-1005",title:"Solicitudes de verificación pendientes",description:"Usuarios esperando revisión manual.",category:"auth",status:l(t.pendingVerifications),priority:c(t.pendingVerifications),href:"/admin/auth",tags:["verification","queue"],metric:`${t.pendingVerifications}`},{id:"ADM-1006",title:"Incidentes de retención fallidos",description:"Tareas operativas con error o retry pendientes.",category:"errors",status:l(t.failedRetention),priority:c(t.failedRetention),href:"/admin/errors",tags:["retention","error"],metric:`${t.failedRetention}`},{id:"ADM-1007",title:"Chats reportados",description:"Conversaciones marcadas para moderación.",category:"chat",status:l(t.reportedChats),priority:c(t.reportedChats),href:"/admin/chats",tags:["chat","moderation"],metric:`${t.reportedChats}`},{id:"ADM-1008",title:"Invitaciones pendientes",description:"Procesos iniciados por empresas esperando respuesta.",category:"chat",status:l(t.pendingInvites),priority:c(t.pendingInvites,5),href:"/admin/chats",tags:["invite","pipeline"],metric:`${t.pendingInvites}`}],chats:A,invites:w,sessions:h,verifications:v,errors:g,activities:_,trafficSeries:E.trafficSeries,deviceBreakdown:E.deviceBreakdown,referrerBreakdown:E.referrerBreakdown,recentUsers:a.recentUsers,recentJobs:a.recentJobs},D=_.filter(e=>"api_request"===e.type);return(0,r.archiveAdminTaskSnapshot)({generatedAt:new Date().toISOString(),tasks:P.tasks,activities:D}),(0,r.archiveAdminRequestActivities)(D),P}e.s(["getAdminChatConversation",0,o],19575),e.s(["getAdminConsole",0,h],49051),e.s([],96664)},77674,e=>{"use strict";var t=e.i(81541),a=e.i(29879),i=e.i(7972),r=e.i(36043),n=e.i(49762),s=e.i(1e3),o=e.i(41081),d=e.i(89819),l=e.i(43460),c=e.i(6359),u=e.i(26260),p=e.i(65708),m=e.i(24135),f=e.i(5316),y=e.i(89554),h=e.i(93695);e.i(16754);var v=e.i(75142);e.i(6456);var g=e.i(57278);e.i(96664);var A=e.i(49051);e.i(9391);var w=e.i(49039);let _="nodejs";async function E(e){let t=(0,w.enforceRateLimit)(e,{scope:"admin-console",maxRequests:120,windowMs:6e4});if(t)return t;let a=await (0,g.requireAdminUser)(e);if(a instanceof Response)return a;let{searchParams:i}=new URL(e.url),r=i.get("activityType")?.trim()||void 0,n=Number(i.get("activityLimit")??""),s=i.get("from"),o=i.get("to");return(0,w.jsonWithSecurity)(await (0,A.getAdminConsole)({activityType:r,activityLimit:Number.isFinite(n)&&n>0?Math.min(1e3,Math.round(n)):void 0,activityFrom:s?new Date(s):null,activityTo:o?new Date(o):null}))}e.s(["GET",0,E,"runtime",0,_],44908),e.s([],48996),e.i(48996),e.i(44908),e.s(["GET",0,E,"runtime",0,_],64977);var S=e.i(64977);let N=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/admin/console/route",pathname:"/api/admin/console",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"frontend",resolvedPagePath:"[project]/frontend/app/api/admin/console/route.ts",nextConfigOutput:"",userland:S,...{}}),{workAsyncStorage:T,workUnitAsyncStorage:R,serverHooks:I}=N;async function C(e,t,i){i.requestMeta&&(0,r.setRequestMeta)(e,i.requestMeta),N.isDev&&(0,r.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let g="/api/admin/console/route";g=g.replace(/\/index$/,"")||"/";let A=await N.prepare(e,t,{srcPage:g,multiZoneDraftMode:!1});if(!A)return t.statusCode=400,t.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve()),null;let{buildId:w,deploymentId:_,params:E,nextConfig:S,parsedUrl:T,isDraftMode:R,prerenderManifest:I,routerServerContext:C,isOnDemandRevalidate:O,revalidateOnlyGenerated:b,resolvedPathname:M,clientReferenceManifest:U,serverActionsManifest:L}=A,P=(0,o.normalizeAppPath)(g),D=!!(I.dynamicRoutes[P]||I.routes[M]),$=async()=>((null==C?void 0:C.render404)?await C.render404(e,t,T,!1):t.end("This page could not be found"),null);if(D&&!R){let e=!!I.routes[M],t=I.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(S.adapterPath)return await $();throw new h.NoFallbackError}}let k=null;!D||N.isDev||R||(k="/index"===(k=M)?"/":k);let q=!0===N.isDev||!D,J=D&&!q;L&&U&&(0,s.setManifestsSingleton)({page:g,clientReferenceManifest:U,serverActionsManifest:L});let x=e.method||"GET",j=(0,n.getTracer)(),F=j.getActiveScopeSpan(),H=!!(null==C?void 0:C.isWrappedByNextServer),B=!!(0,r.getRequestMeta)(e,"minimalMode"),V=(0,r.getRequestMeta)(e,"incrementalCache")||await N.getIncrementalCache(e,S,I,B);null==V||V.resetRequestCache(),globalThis.__incrementalCache=V;let K={params:E,previewProps:I.preview,renderOpts:{experimental:{authInterrupts:!!S.experimental.authInterrupts},cacheComponents:!!S.cacheComponents,supportsDynamicResponse:q,incrementalCache:V,cacheLifeProfiles:S.cacheLife,waitUntil:i.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,i,r)=>N.onRequestError(e,t,i,r,C)},sharedContext:{buildId:w,deploymentId:_}},W=new d.NodeNextRequest(e),X=new d.NodeNextResponse(t),Y=l.NextRequestAdapter.fromNodeNextRequest(W,(0,l.signalFromNodeResponse)(t));try{let r,s=async e=>N.handle(Y,K).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=j.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let i=a.get("next.route");if(i){let t=`${x} ${i}`;e.setAttributes({"next.route":i,"http.route":i,"next.span_name":t}),e.updateName(t),r&&r!==e&&(r.setAttribute("http.route",i),r.updateName(t))}else e.updateName(`${x} ${g}`)}),o=async r=>{var n,o;let d=async({previousCacheEntry:a})=>{try{if(!B&&O&&b&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await s(r);e.fetchMetrics=K.renderOpts.fetchMetrics;let o=K.renderOpts.pendingWaitUntil;o&&i.waitUntil&&(i.waitUntil(o),o=void 0);let d=K.renderOpts.collectedTags;if(!D)return await (0,p.sendResponse)(W,X,n,K.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(n.headers);d&&(t[y.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==K.renderOpts.collectedRevalidate&&!(K.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&K.renderOpts.collectedRevalidate,i=void 0===K.renderOpts.collectedExpire||K.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:K.renderOpts.collectedExpire;return{value:{kind:v.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:i}}}}catch(t){throw(null==a?void 0:a.isStale)&&await N.onRequestError(e,t,{routerKind:"App Router",routePath:g,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:J,isOnDemandRevalidate:O})},!1,C),t}},l=await N.handleResponse({req:e,nextConfig:S,cacheKey:k,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:O,revalidateOnlyGenerated:b,responseGenerator:d,waitUntil:i.waitUntil,isMinimalMode:B});if(!D)return null;if((null==l||null==(n=l.value)?void 0:n.kind)!==v.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(o=l.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});B||t.setHeader("x-nextjs-cache",O?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),R&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,m.fromNodeOutgoingHttpHeaders)(l.value.headers);return B&&D||c.delete(y.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,f.getCacheControlHeader)(l.cacheControl)),await (0,p.sendResponse)(W,X,new Response(l.value.body,{headers:c,status:l.value.status||200})),null};H&&F?await o(F):(r=j.getActiveScopeSpan(),await j.withPropagatedContext(e.headers,()=>j.trace(c.BaseServerSpan.handleRequest,{spanName:`${x} ${g}`,kind:n.SpanKind.SERVER,attributes:{"http.method":x,"http.target":e.url}},o),void 0,!H))}catch(t){if(t instanceof h.NoFallbackError||await N.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:J,isOnDemandRevalidate:O})},!1,C),D)throw t;return await (0,p.sendResponse)(W,X,new Response(null,{status:500})),null}}e.s(["handler",0,C,"patchFetch",0,function(){return(0,i.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:R})},"routeModule",0,N,"serverHooks",0,I,"workAsyncStorage",0,T,"workUnitAsyncStorage",0,R],77674)},49531,e=>{e.v(t=>Promise.all(["server/chunks/backend_lib-server_chat-crypto_ts_04_4h1j._.js"].map(t=>e.l(t))).then(()=>t(32827)))}];

//# sourceMappingURL=_07v.wko._.js.map